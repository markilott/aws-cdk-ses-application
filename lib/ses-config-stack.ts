...
export class SesConfigStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props: SesConfigStackProps) {
        ...
        const sesNotificationsTopic = new Topic(this, 'sesDefaultNotificationsTopic', {
            displayName: 'SES Error Email Notifications',
        });
            ...
            onUpdate: {
                ...
                parameters: {
                    ...
                    EventDestination: {
                        ...
                        MatchingEventTypes: reqEventTypes,
                        Enabled: true,
                    },
                },
                physicalResourceId: {},
